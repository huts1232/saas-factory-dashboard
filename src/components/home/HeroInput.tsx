    ...
    <div className="flex flex-col items-center gap-8 w-full max-w-2xl mx-auto">
      ...
      >
        ...
        <p className="text-text-secondary text-lg">
          Beschrijf je idee. Claude ontwerpt, bouwt en deployt je SaaS.
        </p>
      </motion.div>
        ...
        <div className="relative group">
          ...
          <div className="relative flex items-center bg-bg-card border border-border-default rounded-xl group-focus-within:border-accent/50 transition-colors">
            ...
            <input
              ...
              className="flex-1 bg-transparent px-4 py-4 text-lg text-text-primary placeholder:text-text-muted outline-none"
              autoFocus
            />
            <button
              type="submit"
