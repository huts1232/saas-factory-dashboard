    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-border-default bg-bg-card text-sm font-medium hover:bg-bg-elevated transition-all"
        >
        ...
        <form onSubmit={handleLogin} className="space-y-3">
          ...
          <GlowButton type="submit" variant="accent" loading={loading} className="w-full">Log in</GlowButton>
        </form>
